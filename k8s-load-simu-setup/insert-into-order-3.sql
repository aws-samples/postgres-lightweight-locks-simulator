...
insert into orders30 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders31 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders32 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders33 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders34 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders35 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders36 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders37 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders38 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders39 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
commit
;
