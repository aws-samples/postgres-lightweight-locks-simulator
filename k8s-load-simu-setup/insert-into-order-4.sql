...
insert into orders40 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders41 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders42 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders43 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders44 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders45 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders46 select * from orders where id>(select max(id)-2 from orders) on conflict do nothing;
insert into orders47 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders48 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders49 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
commit
;
