...
insert into orders16 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders17 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders18 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders19 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders20 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders21 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders22 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders23 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders24 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders25 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders26 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders27 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders28 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders29 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
commit
;
