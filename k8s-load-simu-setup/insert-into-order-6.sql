...
insert into orders60 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders61 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders62 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders63 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders64 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders65 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders66 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders67 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders68 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders69 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
commit
;
