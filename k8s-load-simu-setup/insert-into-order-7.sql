...
insert into orders70 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders71 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders72 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders73 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders74 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders75 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders76 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders77 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders78 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders79 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
commit
;
