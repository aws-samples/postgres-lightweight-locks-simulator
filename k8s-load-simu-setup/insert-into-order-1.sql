...
NOW(),
NOW(),
floor(random() * 10000 + 1)::int,floor(random() * 10000 + 1)::int,floor(random() * 10000 + 1)::int,floor(random() * 10000 + 1)::int,floor(random() * 10000 + 1)::int,floor(random() * 10000 + 1)::int,floor(random() * 10000 + 1)::int,floor(random() * 10000 + 1)::int,floor(random() * 10000 + 1)::int,floor(random() * 10000 + 1)::int,
...
insert into orders1 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders2 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders3 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders4 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders5 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders6 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders7 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders8 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders9 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders10 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders11 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders12 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders13 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
insert into orders14 select * from orders where id>(select max(id)-1 from orders) on conflict do nothing;
commit;
